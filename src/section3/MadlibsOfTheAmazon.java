...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String liquid=JOptionPane.showInputDialog("What is a type of liquid?");
		...
		String place=JOptionPane.showInputDialog("What is place?");
		...
		String piranhas=JOptionPane.showInputDialog("Piranhas are more"+adjective+"during the day,so cross the river at night.Piranhas are attracted to fresh"+liquid+"and will most " );
